...
export function createDefaultInfographic(): InfographicData {
  return {
    ...
    layout: {
      ...
      phaseTitleFontSize: 14,
      phaseSubtitleFontSize: 12,
      phaseTitleFontFamily: `'Outfit', sans-serif`,
      phaseSubtitleFontFamily: `'Outfit', sans-serif`,
      phaseTitleColor: '#000000',
      phaseSubtitleColor: '#000000',
      cardTitleFontFamily: `'Outfit', sans-serif`,
      cardContentFontFamily: `'Outfit', sans-serif`,
      cardTitleFontSize: 14,
      cardContentFontSize: 12,
      cardSubtextFontSize: 11,
      cardSubtextFontFamily: `'Outfit', sans-serif`,
      stepLabelColor: '#3c83f6',
      stepLabelTextColor: '#ffffff',
      stepLabelFontFamily: `'Outfit', sans-serif`,
