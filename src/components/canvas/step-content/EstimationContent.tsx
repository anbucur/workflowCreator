...
export const EstimationContent: React.FC<Props> = ({ step }) => {
  ...
  return (
    <div className="space-y-1">
      {value && method === 'tshirt' && (
        <span
          className="inline-block card-text font-bold px-2 py-0.5 rounded mt-1"
      ...
      {value && method !== 'tshirt' && (
        <span className="inline-block card-text font-bold px-2 py-0.5 rounded bg-blue-100 text-blue-800 mt-1">
